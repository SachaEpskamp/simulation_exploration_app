...
navbarPage("Simulation Explorer App", theme = shinytheme("cosmo"),
           tabPanel("Introduction",
                    sidebarLayout(
                      ...
                      sidebarPanel(
                        p("Welcome to the simulation explorer app (SEA). This app was made by Adela Isvoranu and Sacha Epskamp, and is aimed to present results from large-scale simulaton studies on the performance of psychological network estimation from continuous and ordered categorical data. The generating models were Gaussian graphical models. Skewed data were generated by using the exponential function, and ordered categorical data were generated by using threshold models."),
